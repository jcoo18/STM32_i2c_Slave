...
// Pin defines
#define pinRpmPulse PA9
#define pinSpeedPulse PA10
#define ledPin PC13
...
void setup()
{
  ...
  // Initialize timer for calculations
...
void requestEvent()
{
  if (i2c_buffer[0] == 0x01)
  {
    ...
    i2c_buffer[1] = (uint8_t)(rpm & 0xFF);        // LSB
    i2c_buffer[2] = (uint8_t)((rpm >> 8) & 0xFF);
    i2c_buffer[3] = (uint8_t)((rpm >> 16) & 0xFF);
    i2c_buffer[4] = (uint8_t)((rpm >> 24) & 0xFF); // MSB
    i2c_buffer[5] = (uint8_t)(speed & 0xFF);        // LSB
    i2c_buffer[6] = (uint8_t)((speed >> 8) & 0xFF);
    i2c_buffer[7] = (uint8_t)((speed >> 16) & 0xFF);
    i2c_buffer[8] = (uint8_t)((speed >> 24) & 0xFF); // MSB
